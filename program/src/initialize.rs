...
/// Initialize sets up the GARY program to begin mining.
pub fn process_initialize(accounts: &[AccountInfo<'_>], _data: &[u8]) -> ProgramResult {
    ...
    bus_0_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[0]], &gary_api::ID)?;
    bus_1_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[1]], &gary_api::ID)?;
    bus_2_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[2]], &gary_api::ID)?;
    bus_3_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[3]], &gary_api::ID)?;
    bus_4_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[4]], &gary_api::ID)?;
    bus_5_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[5]], &gary_api::ID)?;
    bus_6_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[6]], &gary_api::ID)?;
    bus_7_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[7]], &gary_api::ID)?;
    config_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[CONFIG], &gary_api::ID)?;
    ...
    mint_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[MINT, MINT_NOISE.as_slice()], &gary_api::ID)?;
    treasury_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[TREASURY], &gary_api::ID)?;
    ...
    for i in 0..BUS_COUNT {
        ...
        let bus = bus_infos[i].as_account_mut::<Bus>(&gary_api::ID)?;
        bus.id = i as u64;
        bus.rewards = 0;
    ...
    let config = config_info.as_account_mut::<Config>(&gary_api::ID)?;
