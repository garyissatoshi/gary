use gary_api::consts::{EPOCH_DURATION, BUS_ADDRESSES, TREASURY_TOKENS_ADDRESS, TREASURY_ADDRESS};
...
impl Miner {
    ...
    async fn fetch_treasury_data(&self, data: &mut Vec<TableData>) {
        ...
        data.push(TableData {
            ...
            value: format!("{} GARY", token_balance.token_amount.ui_amount_string),
        });
    }
}